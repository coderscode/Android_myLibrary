...
public class GithubLocalCache {
     ...
     */
    public void insert(List<HistoryFroimDb> repos, InsertCallback callback) {
        ioExecutor.execute(() -> {
...
//     * @param name repository name
     */
    public DataSource.Factory<Integer, HistoryFroimDb> reposByName() {
...
public List<HistoryFroimDb> loaddata()
{

    return repoDao.findUserWithName();
}
